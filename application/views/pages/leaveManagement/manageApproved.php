...
<title>Leave Management</title>
    <div class="base_content container-fluid mt-4">
        ...
        <ul class="nav navbg py-1 mb-3">
            <div class="container-fluid d-flex">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="<?= site_url('manageapproved')?>">Approved
                        <?php if($a > 0) : ?>
    ...
    <div class="container-fluid pt-3">
        <?php if($a > 0) : ?>
            ...
            <p class="sub_title">List of Approved Requests</p>
            <hr>
                            ...
                            "columns": [
                                ...
                                { "data": "datestamp" },
                                {
                                    ...
                                    "render": function ( data, type, row, meta ) {
                                        return '<a class="btn" href="<?php echo site_url('LeaveManage/viewApproved');?>/'+data+'" id="ShowButton" value="'+data+'" data-bs-toggle="tooltip" data-bs-placement="top" title="Show Details"><i class="bi bi-eye-fill"></i></a>';
                                    }
                                },
                            ]
                        } );
