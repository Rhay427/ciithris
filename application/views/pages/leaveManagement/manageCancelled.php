...
<title>Leave Management</title>
    <div class="base_content container-fluid mt-4">
        ...
        <ul class="nav navbg py-1 mb-3">
            <div class="container-fluid d-flex">
                <li class="nav-item">
                    <a class="nav-link"  href="leaveManagement">Pending
                        <?php if($p > 0) : ?>
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="<?= site_url('managecancelled')?>">Cancelled 
                        <?php if($c > 0) : ?>
    ...
    <div class="container-fluid pt-3">
        <?php if($c > 0) : ?>
            ...
            <p class="sub_title">List of Cancelled Requests</p>
            <hr>
                            ...
                            "columns": [
                                ...
                                { "data": "datestamp" },
                                {
                                    ...
                                    "render": function ( data, type, row, meta ) {
                                        return '<a class="btn" href="<?php echo site_url('LeaveManage/viewCancelled');?>/'+data+'" id="ShowButton" value="'+data+'" data-bs-toggle="tooltip" data-bs-placement="top" title="Show Details"><i class="bi bi-eye-fill"></i></a>';
                                    }
                                },
                            ]
                        } );
